...
public class TC_BILLING_026 {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//select")).sendKeys("india");
		driver.findElement(By.xpath("//select[@id='StateProvinceId']")).sendKeys("Andhra Pradesh");
		driver.close();
	}
