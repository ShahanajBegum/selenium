...
public class TC_SHOPPING_CART_013 {
	...
	public static void main(String[] args) {
		...
		act.moveToElement(driver.findElement(By.name("q"))).click().sendKeys("computer").perform();
		act.moveToElement(driver.findElement(By.xpath("//input[@value='Search']"))).click().perform();
		driver.close();
