...
public class TC_ENQUIRY_019 {
	...
	public static void main(String[] args) {
		...
		name.clear();
		name.sendKeys("Anumula Santhosh");
		WebElement email = driver.findElement(By.xpath("//input[@placeholder='Enter your email address']"));
		email.clear();
		email.sendKeys("anumulasanthosh39@gmail.com");
		driver.findElement(By.cssSelector("textarea[class='enquiry']")).sendKeys("hjdhcgs2569368vaj");
